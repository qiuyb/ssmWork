...
(
  ...
  vuStatus    NUMBER(6) not null,              --用户状态   //1未激活  2激活
  vuVersion   NUMBER(10) not null,              --角色    //1.管理员     0.普通用户
  vuEmail varchar2(100) not null
);
	create sequence seq_vuId start with 100010
  delete from VoteUser where vuUsername='qyb'
...
delete from VoteSubject where vsId=441
--投票内容对应的选项表
...
select *  from VoteUser
drop table VoteItem;
select count(distinct vuId) from VoteItem where vsId=101;
...
values ('ss', 100000, 'a', 1, 1,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('admin', 100001, 'a', 2, 1,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('zy', 100002, 'a', 1, 0,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('yc', 100003, 'a', 2, 0,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('yc1', 100004, 'a', 2, 1,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('yc2', 100005, 'a', 2, 1,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('yc3',100006, 'a', 2, 1,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('yc4',100007, 'a', 2, 1,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('yc5', 100008, 'a', 2, 1,'yc@qq.com');
insert into VoteUser (vuUsername,vuId, vuPassword, vuStatus, vuVersion,vuEmail)
values ('yc6', 100009, 'a', 1, 0,'yc@qq.com');
