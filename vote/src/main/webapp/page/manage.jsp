...
<body>
	...
	<div id="navbar" class="wrap">
		<div class="profile">
			您好，${sessionScope.user.vuusername } <span class="return"><a href="vote_list.action">返回列表</a></span>
			<span class="addnew"><a href="Subject!read.action">添加新投票</a></span> <span
		...
		<ul class="list">
			<c:forEach items="${sessionScope.subjects }" var="subject"
				...
				<li <c:if test="${status.index%2==0 }">class="odd"</c:if>>
					...
					<div class="edit">
						<a href="vote_vote.action?vsId=${subject.vsId }">我要维护</a>
					</div>
